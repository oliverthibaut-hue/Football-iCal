#!/usr/bin/env python3
"""Fusionne l'historique Málaga CF avec le calendrier automatique courant.

Le fichier historique est statique et nettoyé. Le fichier automatique est régénéré
à chaque exécution. Le résultat remplace Malaga-CF.ics.
"""
...
HISTORY_FILE = BASE_DIR / "malaga-history.ics"
CURRENT_FILE = BASE_DIR / "Malaga-CF.ics"
...
def write_calendar(events: list[list[str]], path: Path) -> None:
    lines = [
        ...
        "CALSCALE:GREGORIAN",
        "METHOD:PUBLISH",
        "PRODID:-//Football-iCal//Malaga Combined//FR",
        "X-WR-CALNAME:Málaga CF",
    ]
...
def main() -> None:
    ...
    print("FUSION HISTORIQUE MÁLAGA CF")
